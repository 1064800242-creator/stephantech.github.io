...
@media(max-width:560px){.demo-sidebar{display:block;position:fixed;inset:auto 14px 14px auto;width:auto;height:auto;padding:0;background:transparent;border:0;z-index:55}.demo-brand,.demo-sidebar nav,.demo-profile{display:none}.feedback-link{display:block;box-shadow:0 8px 24px rgba(0,0,0,.35);background:#12241e;padding:11px 15px}.feedback-link span{display:inline}}
